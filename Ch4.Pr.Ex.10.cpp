...
int main ()
{
    ...
    cout << endl;
    cout << "Enter amount to invest in saving bonds: $";
    cin >> savingBonds;
    cout << endl;

    if (savingBonds == 0)
        additionalBonds = 0.01 * netIncome;
    else if (savingBonds <= 0.25 * netIncome)
        additionalBonds = 0.25 * static_cast<int>(savingBonds) + 0.01 * netIncome;
    else if (savingBonds > 0.25 * netIncome)
        additionalBonds = 0.40 * static_cast<int>(savingBonds) + 0.02 * netIncome;
